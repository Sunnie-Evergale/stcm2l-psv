...
Changelog:
    ...
    v1.1.20 - Fixed index collision bug in merging logic
        ...
        - Sort now uses (index, offset) to preserve file order
        - Fixed truncated entries 1014 and 1018 in file 106
    v1.1.19 - Added Type 0x11 support
        - Added Type 0x11 to valid types list and combining logic
        - Type 0x11 entries now correctly extracted as dialogue continuation
        - Fixed truncated entry 920 (and 14 others) in file 106
    v1.1.18 - Added Type 0x10 support
        - Added Type 0x10 to valid types list and combining logic
        - Implemented special size handling for Type 0x10 (uses placeholder 0x4000)
        - Type 0x10 entries now correctly extracted as dialogue continuation
